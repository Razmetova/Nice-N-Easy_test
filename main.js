...
class Thing
{
  ...
  { 
    ...
    if(!!this.dir) {
      let boyCell = document.querySelector('#boyCell');
      if((currDir === "W" && this.dir === "W") ||
         (currDir === "S" && this.dir === "S") ||
         (currDir === "N" && this.dir === "N") ||
         (currDir === "E" && this.dir === "E") ||
         (currDir === "W" && this.dir === "E") ||
         (currDir === "E" && this.dir === "W") ||
         (currDir === "N" && this.dir === "S") ||
         (currDir === "S" && this.dir === "N") ) {
        boyCell.style.transform = `rotate(${this.currDeg}deg)`;
      } else if((currDir === "S" && this.dir === "W") ||
                (currDir === "W" && this.dir === "N") ||
                (currDir === "N" && this.dir === "E") ||
                (currDir === "E" && this.dir === "S")) {
          boyCell.style.transform = `rotate(${this.currDeg = this.currDeg + 90}deg)`;
      } else if((currDir === "W" && this.dir === "S") ||
                (currDir === "N" && this.dir === "W") ||
                (currDir === "E" && this.dir === "N") ||
                (currDir === "S" && this.dir === "E")) {
        boyCell.style.transform = `rotate(${this.currDeg = this.currDeg - 90}deg)`;
      }
    }
    if(!!this.state)
...
{   
  ...
  .filter(thing=> (thing.cell.x>=boy.cell.x-13)
                ...
                &&(thing.cell.y<=boy.cell.y+13))
  .forEach(thing=>thing.updateSelf(currDir));
